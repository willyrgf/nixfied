...
let
  ...
  vendoredMetadataRuntime = import ./internal/vendored-metadata.nix { inherit pkgs; };

  sourceRootAbs = builtins.toString sourceRoot;
  repoRootAbs = builtins.toString repoRoot;
in
{
...
''
        ...
        source_root=${pkgs.lib.escapeShellArg sourceRootAbs}
        repo_root=${pkgs.lib.escapeShellArg repoRootAbs}
        target="."
