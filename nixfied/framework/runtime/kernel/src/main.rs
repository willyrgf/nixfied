...
fn usage() -> String {
    [
        ...
        "  task <export|help|runtime-plan|base-closure-selected-services|retry-backoff-values|hook-ids|hook-export|env-names|run|validate-args> ...",
        "  workflow <export|unit-closure-selected-services|env-names|resolve-mode|run> ...",
