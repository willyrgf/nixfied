...
fn usage() -> String {
    [
        ...
        "  task <export|help|runtime-plan|base-closure-selected-services|selected-services-csv|retry-backoff-values|hook-ids|hook-export|env-names|run|validate-args> ...",
        "  workflow <export|export-resolved|unit-closure-selected-services|selected-services-csv|env-names|resolve-mode|run> ...",
