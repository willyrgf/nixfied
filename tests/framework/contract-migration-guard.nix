...
let
  ...
  deletedHelperPaths = [
    ...
    ../../nixfied/framework/runtime/helpers/value-string.nix
...
assert !(pkgs.lib.hasInfix "task_base_closure_selected_services() {" runtimeHandoffSource);
assert !(pkgs.lib.hasInfix "workflow_unit_closure_selected_services() {" runtimeHandoffSource);
assert !(pkgs.lib.hasInfix "task_invocation_selected_services() {" runtimeHandoffSource);
assert !(pkgs.lib.hasInfix "task_runtime_plan_shell() {" runtimeHandoffSource);
assert !(pkgs.lib.hasInfix "task_retry_backoff_values() {" runtimeHandoffSource);
assert !(pkgs.lib.hasInfix "task_hook_ids() {" runtimeHandoffSource);
assert !(pkgs.lib.hasInfix "task_hook_command() {" runtimeHandoffSource);
assert !(pkgs.lib.hasInfix "task_hook_runtime_plan_shell() {" runtimeHandoffSource);
assert !(pkgs.lib.hasInfix "task_runner_type() {" runtimeHandoffSource);
assert !(pkgs.lib.hasInfix "task_runner_command() {" runtimeHandoffSource);
assert !(pkgs.lib.hasInfix "task_runner_package() {" runtimeHandoffSource);
assert !(pkgs.lib.hasInfix "task_runner_workflow_id() {" runtimeHandoffSource);
assert !(pkgs.lib.hasInfix "task_produces_json() {" runtimeHandoffSource);
assert !(pkgs.lib.hasInfix "task_max_attempts() {" runtimeHandoffSource);
assert !(pkgs.lib.hasInfix "task_hook_count() {" runtimeHandoffSource);
assert !(pkgs.lib.hasInfix "workflow_mode_name() {" runtimeHandoffSource);
assert !(pkgs.lib.hasInfix "workflow_artifacts_root() {" runtimeHandoffSource);
assert !(pkgs.lib.hasInfix "workflow_ephemeral_flag() {" runtimeHandoffSource);
assert !(pkgs.lib.hasInfix "workflow_logging_level_default() {" runtimeHandoffSource);
assert !(pkgs.lib.hasInfix "workflow_logging_output_default() {" runtimeHandoffSource);
assert !(pkgs.lib.hasInfix "workflow_parallel_enabled() {" runtimeHandoffSource);
assert !(pkgs.lib.hasInfix "workflow_max_workers() {" runtimeHandoffSource);
assert !(pkgs.lib.hasInfix "workflow_write_summary() {" runtimeHandoffSource);
