...
assert pkgs.lib.hasInfix "task_descriptor_exists \"$task_id\"" orchestratorSource;
assert pkgs.lib.hasInfix "task_arg_long_kind \"$task_id\"" orchestratorSource;
...
assert pkgs.lib.hasInfix "frameworkEphemeral = import ../.framework/ephemeral.nix"
  orchestratorSource;
