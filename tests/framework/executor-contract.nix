...
assert pkgs.lib.hasInfix "\"attempt_id\":%s" source;
assert pkgs.lib.hasInfix "summary_fields_file_for() {" source;
assert pkgs.lib.hasInfix "summary_steps_file_for() {" source;
...
assert pkgs.lib.hasInfix "json_quote_string \"slotLifecycle\"" source;
assert pkgs.lib.hasInfix "json_quote_string \"serviceLifecycle\"" source;
...
assert pkgs.lib.hasInfix "SUMMARY_PASSED_COUNT=" source;
